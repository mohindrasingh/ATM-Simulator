...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        ButtonGroup groutexisting = new ButtonGroup();
        groutexisting.add(r3);
        groutexisting.add(r4);
        ...
        String category[] = {"Select","Genral","OBC","SC","ST","Other"};
        c2 = new JComboBox(category);
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway", Font.BOLD, 14));

        String income[] = {"Null","<250,000","<150,000","<5,00,000","Upto 10,00,000","Above 10,00,000"};
        ...
        String occupation[] = {"Select","Salaried","Self-Employed","Business","Student","Retired","Farmer","Other"};
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String pan = (String)t1.getText();
        String aadhar = (String)t2.getText();
